...
class MyTestCase(unittest.TestCase):
    ...
    def test_deposit_positive_amount(self):
        account = Account("praise", "1111", 1)
        self.assertEqual(0, account.get_balance("1111"))
        account.deposit(2000)
        self.assertEqual(2000, account.get_balance("1111"))
    ...
    def test_deposit_2k_and_5k_balance_is_7k(self):
        ...
        self.assertEqual(7000, account.get_balance("1111"))
    ...
    def test_deposit_5k_withdraw_2k_balance_is_3k(self):
        ...
        self.assertEqual(3000, account.get_balance("1111"))
    ...
    def test_deposit_5k_withdraw_2k_with_invalid_pin_balance_is_5k(self):
        ...
        self.assertEqual(5000, account.get_balance("1111"))
    ...
    def test_deposit_6k_withdraw_7k_raise_insufficient_funds(self):
        ...
        with self.assertRaises(Exception):
            ...
            self.assertEqual(6000, account.get_balance("1111"))
